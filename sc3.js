                ...
                if (document.getElementById("d68da85e-0aba-4a19-9e0d-67b38386d18a")) {
                    Plotly.newPlot(
                        "d68da85e-0aba-4a19-9e0d-67b38386d18a",
                        [
                            { marker: { color: "blue" }, name: "Training Time", x: ["Training Time"], y: [10], type: "bar" },
                            { marker: { color: "green" }, name: "Inference Time", x: ["Inference Time"], y: [20], type: "bar" },
                            { marker: { color: "orange" }, name: "Model Size", x: ["Model Size"], y: [30], type: "bar" },
                        ],
                        {
                            template: {
                                data: {
                            ...
                            title: { text: "AI Model Performance Metrics" },
